      ...
      <main className="mx-auto max-w-4xl px-6 py-16 lg:px-8">
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
          ...
          <div className="prose prose-green max-w-none space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">2. Description of Service</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">3. User Accounts and Registration</h2>
              <p className="text-emerald-900 leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">4. User Conduct and Responsibilities</h2>
              <p className="text-emerald-900 leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">5. Transactions and Payments</h2>
              <p className="text-emerald-900 leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">6. Intellectual Property Rights</h2>
              <p className="text-emerald-900 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">7. Data and Privacy</h2>
              <p className="text-emerald-900 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">8. Disclaimers and Limitations of Liability</h2>
              <p className="text-emerald-900 leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">9. Termination</h2>
              <p className="text-emerald-900 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">10. Governing Law and Dispute Resolution</h2>
              <p className="text-emerald-900 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">11. Changes to Terms</h2>
              <p className="text-emerald-900 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">12. Contact Information</h2>
              <p className="text-emerald-900 leading-relaxed">
                If you have any questions about these Terms of Service, please contact us:
              </p>
              <div className="bg-emerald-50 rounded-xl p-6 mt-4 space-y-2">
                <p className="text-emerald-900"><strong>Email:</strong> legal@farmcon.in</p>
