    ...
    try {
      ...
      if (error) {
        ...
        try {
          ...
          if (!profile) {
            // If profile doesn't exist, there's an issue - redirect to signup
            setError('Profile not found. Please sign up again.')
            return
          }
          
          // Redirect to dashboard regardless of role (all roles use same dashboard with different navigation)
