      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-slate-700">Expert Consultations</h1>
              <p className="text-slate-700 mt-2">Book free consultations with agricultural experts</p>
            </div>
            <Link
              href="/dashboard"
                ...
                <div key={expert.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4 py-4 border-t border-b border-gray-100">
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-slate-700">{expert.experience}</div>
                        <div className="text-xs text-slate-700">Experience</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-slate-700">{expert.consultations}+</div>
                        <div className="text-xs text-slate-700">Consultations</div>
                      </div>
                    </div>

                    {}
                    <div className="mb-4">
                      <div className="text-xs text-slate-700 mb-2">Languages:</div>
                      <div className="flex flex-wrap gap-2">
                        {expert.languages.map((lang) => (
                          <span key={lang} className="bg-slate-100 text-slate-600 px-2 py-1 rounded text-xs">
                            {lang}
                          </span>
                        ))}
                      </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-slate-700">{selectedExpert?.name}</h2>
                    <p className="text-slate-700">{selectedExpert?.specialty}</p>
                  </div>
                </div>
                <button
                  onClick={() => {
