...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <nav className="flex h-20 items-center justify-between">
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="relative w-12 h-12 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                <Wheat className="w-7 h-7 text-white" />
              </div>
              <div>
                <span className="text-2xl font-bold bg-gradient-to-r from-emerald-600 to-emerald-600 bg-clip-text text-transparent">FarmCon</span>
                <p className="text-xs text-slate-600">Smart Farming</p>
              </div>
            </Link>
            <Link
              href="/"
              className="flex items-center gap-2 text-sm font-semibold text-emerald-900 hover:text-emerald-600 transition-colors"
            >
      ...
      <main className="mx-auto max-w-4xl px-6 py-16 lg:px-8">
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600">Last updated: {new Date().toLocaleDateString('en-IN', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
          </div>
          ...
          <div className="prose prose-green max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-emerald-50 rounded-xl p-6">
                  <h3 className="text-xl font-bold text-emerald-950 mb-3">Information You Provide to Us</h3>
                ...
                <div className="bg-blue-50 rounded-xl p-6">
                  <h3 className="text-xl font-bold text-emerald-950 mb-3">Information Collected Automatically</h3>
                  <ul className="list-disc pl-6 space-y-2 text-emerald-900">
                ...
                <div className="bg-purple-50 rounded-xl p-6">
                  <h3 className="text-xl font-bold text-emerald-950 mb-3">Information from Third Parties</h3>
                  <ul className="list-disc pl-6 space-y-2 text-emerald-900">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">4. How We Share Your Information</h2>
              <p className="text-emerald-900 leading-relaxed mb-3">
              ...
              <div className="space-y-3">
                <div className="border-l-4 border-emerald-500 pl-4">
                  <h3 className="font-bold text-emerald-950 mb-1">With Other Users</h3>
                  <p className="text-emerald-900">Your public profile, product listings, and reviews may be visible to other FarmCon users. You can control what information is public in your privacy settings.</p>
                </div>

                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-bold text-emerald-950 mb-1">With Service Providers</h3>
                  <p className="text-emerald-900">We work with third-party companies for payment processing, cloud hosting, analytics, customer support, and marketing services. These providers only access information needed to perform their services.</p>
                </div>

                <div className="border-l-4 border-purple-500 pl-4">
                  <h3 className="font-bold text-emerald-950 mb-1">For Business Transactions</h3>
                  <p className="text-emerald-900">If FarmCon is involved in a merger, acquisition, or sale of assets, your information may be transferred to the new owner.</p>
                </div>

                <div className="border-l-4 border-red-500 pl-4">
                  <h3 className="font-bold text-emerald-950 mb-1">Legal Requirements</h3>
                  <p className="text-emerald-900">We may disclose your information if required by law, court order, or to protect rights, property, or safety of FarmCon, our users, or the public.</p>
                </div>

                <div className="border-l-4 border-amber-500 pl-4">
                  <h3 className="font-bold text-emerald-950 mb-1">With Your Consent</h3>
                  <p className="text-emerald-900">We may share your information with other parties when you give us explicit permission to do so.</p>
                </div>
              </div>

              <p className="text-emerald-900 leading-relaxed mt-4">
            ...
            <section>
              ...
              <p className="text-emerald-900 leading-relaxed mt-3">
                However, no method of transmission over the internet is 100% secure. While we strive to protect your data, we cannot guarantee absolute security.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">6. Your Privacy Rights</h2>
              <p className="text-emerald-900 leading-relaxed mb-3">
                You have the following rights regarding your personal information:
              </p>

              <div className="bg-gradient-to-r from-emerald-50 to-emerald-50 rounded-xl p-6 space-y-3">
                <div>
                  <h3 className="font-bold text-emerald-950">Access</h3>
                  <p className="text-emerald-900">Request a copy of the personal information we hold about you</p>
                </div>
                <div>
                  <h3 className="font-bold text-emerald-950">Correction</h3>
                  <p className="text-emerald-900">Update or correct inaccurate or incomplete information</p>
                </div>
                <div>
                  <h3 className="font-bold text-emerald-950">Deletion</h3>
                  <p className="text-emerald-900">Request deletion of your personal information (subject to legal obligations)</p>
                </div>
                <div>
                  <h3 className="font-bold text-emerald-950">Data Portability</h3>
                  <p className="text-emerald-900">Request a copy of your data in a structured, machine-readable format</p>
                </div>
                <div>
                  <h3 className="font-bold text-emerald-950">Objection</h3>
                  <p className="text-emerald-900">Object to certain processing of your personal information, especially for marketing purposes</p>
                </div>
                <div>
                  <h3 className="font-bold text-emerald-950">Restriction</h3>
                  <p className="text-emerald-900">Request that we restrict processing of your information in certain circumstances</p>
                </div>
                <div>
                  <h3 className="font-bold text-emerald-950">Withdraw Consent</h3>
                  <p className="text-emerald-900">Withdraw consent for processing where consent was the legal basis</p>
                </div>
              </div>
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">8. Children's Privacy</h2>
              <p className="text-emerald-900 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">9. International Data Transfers</h2>
              <p className="text-emerald-900 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">10. Changes to This Privacy Policy</h2>
              <p className="text-emerald-900 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">11. Contact Us</h2>
              ...
              <div className="bg-emerald-50 rounded-xl p-6 space-y-2">
                <p className="text-emerald-900"><strong>Privacy Officer:</strong> FarmCon Privacy Team</p>
                <p className="text-emerald-900"><strong>Email:</strong> privacy@farmcon.in</p>
                <p className="text-emerald-900"><strong>Phone:</strong> +91 1800-XXX-XXXX (Toll Free)</p>
                <p className="text-emerald-900"><strong>Address:</strong> FarmCon Technologies Pvt. Ltd., Bangalore, Karnataka, India</p>
            ...
            <div className="bg-gradient-to-r from-emerald-100 to-emerald-100 rounded-xl p-6 mt-8">
              <h3 className="text-lg font-bold text-emerald-950 mb-2">Our Commitment to Farmers</h3>
          ...
          <div className="mt-12 pt-8 border-t border-slate-200 text-center">
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-emerald-600 to-emerald-600 text-white font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105"
            >
              <ArrowLeft className="w-4 h-4" />
              Return to Home
            </Link>
      ...
      {/* Footer */}
      <footer className="bg-emerald-950 text-slate-400 py-8">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
