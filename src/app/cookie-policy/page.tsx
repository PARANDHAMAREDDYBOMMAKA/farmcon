      ...
      <main className="mx-auto max-w-4xl px-6 py-16 lg:px-8">
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
          ...
          <div className="prose prose-green max-w-none space-y-8">
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">1. What Are Cookies?</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">2. How FarmCon Uses Cookies</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">3. Types of Cookies We Use</h2>

              <div className="space-y-6">
                <div className="bg-emerald-50 rounded-xl p-6">
                  <h3 className="text-xl font-bold text-emerald-950 mb-3">Essential Cookies (Required)</h3>
                ...
                <div className="bg-blue-50 rounded-xl p-6">
                  <h3 className="text-xl font-bold text-emerald-950 mb-3">Functional Cookies (Optional)</h3>
                  <p className="text-emerald-900 leading-relaxed mb-2">
                ...
                <div className="bg-purple-50 rounded-xl p-6">
                  <h3 className="text-xl font-bold text-emerald-950 mb-3">Analytics Cookies (Optional)</h3>
                  <p className="text-emerald-900 leading-relaxed mb-2">
                ...
                <div className="bg-amber-50 rounded-xl p-6">
                  <h3 className="text-xl font-bold text-emerald-950 mb-3">Marketing Cookies (Optional)</h3>
                  <p className="text-emerald-900 leading-relaxed mb-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">4. Third-Party Cookies</h2>
              <p className="text-emerald-900 leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">5. How Long Do Cookies Last?</h2>
              <p className="text-emerald-900 leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">6. Managing Your Cookie Preferences</h2>
              <p className="text-emerald-900 leading-relaxed mb-3">
                You have control over cookies and can manage them in several ways:
              </p>

              <div className="bg-gradient-to-r from-emerald-50 to-emerald-50 rounded-xl p-6 mb-4">
                <h3 className="text-lg font-bold text-emerald-950 mb-3">Cookie Consent Banner</h3>
                <p className="text-emerald-900 leading-relaxed mb-2">
              ...
              <div className="bg-slate-50 rounded-xl p-6">
                <h3 className="text-lg font-bold text-emerald-950 mb-3">Browser Settings</h3>
                <p className="text-emerald-900 leading-relaxed mb-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">7. Do Not Track Signals</h2>
              <p className="text-emerald-900 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">8. Mobile Application</h2>
              <p className="text-emerald-900 leading-relaxed">
                Our mobile application may use similar technologies to cookies, including:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-emerald-900 mt-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-emerald-950 mb-4">9. Updates to This Policy</h2>
              <p className="text-emerald-900 leading-relaxed">
