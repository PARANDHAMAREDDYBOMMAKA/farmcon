    ...
    <div className={className}>
      ...
      {images.length === 0 && (
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
          <Camera className="w-16 h-16 text-gray-900 mx-auto mb-2" />
          <p className="text-gray-900">No images uploaded yet</p>
          <p className="text-gray-900 text-sm">Click "Add Images" to upload crop photos</p>
        </div>
      )}
    </div>
  )
